...
/**
 * Generated Module handling code
 * 
 * @category      module
 * @package       varmapper
...
class hboVarMapperModule extends oxModule {
    ...
    public function getSetting($sModuleSettingName, $blUseModulePrefix = true) {
        if ($blUseModulePrefix) {
            $sModuleSettingName = 'hboColMapper' . (string) $sModuleSettingName;
        }
    ...
    public function getPath() {
        return oxRegistry::getConfig()->getModulesDir() . 'hbo/colmapper/';
    }
